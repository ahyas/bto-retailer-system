...
$(document).ready(function(){
    ...
    var table = $(".tb_warehouse").DataTable({
            ...
            {data:"id_item",
                ...
                {
                    return'<button data-category='+full["category"]+' data-id_item='+data+' class="btn btn-sm edit" id="bto-button">Edit</button> <button data-id_item='+data+' class="btn btn-sm delete" id="bto-button">Delete</button>';
                }
            }
        ]
    });

    //Start table numbering
