...
<head>
    ...
    <title>Report permintaan barang</title>
        ...
        <div class="col-md-12 mt-5">
            <div class="card" style="border:1px solid #9bbbe3; box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
                ...
                <div class="card-header"  style="background-image: linear-gradient(#d0e2f8, #e2ecfb); height: 30px; line-height: 6px; font-size: 13px; border-top: 1px white solid">
                    <p style="line-height: 0; color:#0a4293; font-weight:normal; font-size:14px; font-weight:600;">Report permintaan barang</p>
                </div>
                <div class="card-body" style="background-color:#f0f0f0; font-size:13px;">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-sm">
                                <label>User</label>
                                <select class="form-control form-control-sm fx user" id="user">
                                    <option value="0">Semua user</option>
                                    @foreach($user as $row)
                                    <option value="{{$row->id}}">{{$row->nama_pemakai}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-sm">
                                <button class="btn btn-primary btn-sm" style="margin-top:25px;" id="cari">Cari</button> <button class="btn btn-success btn-sm" style="margin-top:25px;" id="reset" disabled="true">Reset</button>
                            </div>
