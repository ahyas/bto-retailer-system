        ...
        <div class="col-md-12 mt-5">
            <div class="card" style="border:1px solid #9bbbe3; box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
                <div class="card-header" style="background-image: linear-gradient(#d0e2f8, #e2ecfb); height: 30px; line-height: 6px; font-size: 13px; border-top: 1px white solid">
                    <p style="line-height: 0; color:#0a4293; font-weight:normal; font-size:14px; font-weight:600;">Daftar barang</p>
                </div>
                <div class="card-body" style="background-color:#f0f0f0; font-size:13px;">
                <a href="javascript:void(0)" class="btn btn-success btn-sm add" style="font-size:13px; border:1px solid #9c9a9a;">Add</a>
                <br>
                <br>
                    <table class="tb_barang display table-sm" style="font-size:13px; border:1px solid #9c9a9a;" width="100%">
                        <thead style="background-image: linear-gradient(#ecf6f8, #d7dfe1); line-height:3px;">
                            <tr>
                                <td>Kode barang</td>
                                <td>Jenis Barang</td>
                                <td>Kategori Barang</td>
                                <td width="300px">Nama Barang</td>
                                <td>Stock</td>
                                <td>Satuan</td>
                                <td>Action</td>
                            </tr>
    ...
    $(".tb_barang").DataTable({
        ...
        [
            ...
            {data:"id_barang",
                ...
                {
                    return'<a href="javascript:void(0)" data-kode_jenis='+full["kode_jenis"]+' data-id_barang='+data+' class="btn btn-warning btn-sm edit">Edit</a> <a href="javascript:void(0)" data-id_barang='+data+' class="btn btn-danger btn-sm delete">Delete</a>';
                }
            }
        ]
    });
